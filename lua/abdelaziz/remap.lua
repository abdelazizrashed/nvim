...
wk.add({
    ...
    { "<leader>3",        ":%s#",                                                       desc = "Search and replace with hash",         mode = "n" },
    ...
    { "]c",               "<cmd>GitConflictNextConflict<CR>",                           desc = "Next Git Conflict",                    mode = "n" },
    { "[c",               "<cmd>GitConflictPrevConflict<CR>",                           desc = "Previous Git Conflict",                mode = "n" },
    -- Group git conflict actions under <leader>c
    { "<leader>c",        group = "Git Conflict" },
    { "<leader>co",       "<cmd>GitConflictChooseOurs<CR>",                             desc = "Choose Ours",                          mode = "n" },
    { "<leader>ct",       "<cmd>GitConflictChooseTheirs<CR>",                           desc = "Choose Theirs",                        mode = "n" },
    { "<leader>cb",       "<cmd>GitConflictChooseBoth<CR>",                             desc = "Choose Both",                          mode = "n" },
    { "<leader>cn",       "<cmd>GitConflictChooseNone<CR>",                             desc = "Choose None",                          mode = "n" },
})
